...
<html>
<head>
<title>Online Registration | Administration</title>
<link rel="stylesheet" href="auth/style.css" type="text/css" media="screen" />
  ...
  <div class="login_box">
    ...
    <form method="post">
      ...
      <td class="label"></td><td class="input_label"><input class="submit_button" type="submit" name="xsubmit" value="Submit"></td>
      </tr>
      </table>
    </form>
