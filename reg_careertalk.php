...
<div class="box_title">Register for Career Talk Session</div>
<?php
...
<?php 
 ...
 mysql_query("INSERT $careertalk SET name='$name', matrix='$matrix', ic='$ic', course='$course', year='$year', address='$address', email='$email', phone='$phone', company='$comp', register='$type', date='$date', time='$time'")
 or die(mysql_error()); 
 // once saved, redirect back to the view page
 header('Location: reg_careertalk_success.php');
 }
 }
 else
