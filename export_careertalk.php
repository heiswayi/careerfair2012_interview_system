...
<?php
include('config.php');
$result = mysql_query("SELECT * FROM $careertalk ORDER BY name") or die(mysql_error());
$totalpeople = mysql_num_rows($result);

echo '<h2>Attendee Details for Career Talk Session (' . $totalpeople . ') <a target="_blank" href="javascript:window.print()">PRINT</a></h2>';
echo '<p class="printby"><a href="list_careertalk.php">&larr; Back to System</a> | <a href="export_careertalk_bydate.php">Sort by Date</a> | <a href="export_careertalk_bytime.php">Sort by Time</a> | <a href="export_careertalk_bycompany.php">Sort by Company</a></p>';
