...
<a class="uiButton uiButtonNormal" href="list_sessions.php">&larr; Back</a> <a class="uiButton uiButtonNormal" href="list_sessions_careertalk.php">Career Talk Only</a>
...
<?php
include('config.php');
$result = mysql_query("SELECT * FROM $company WHERE type='Interview' ORDER BY id DESC") or die(mysql_error());
$totalsession = mysql_num_rows($result);
echo '<div class="box_title">' . $totalsession . ' session(s) available for <u>Interview Session</u></div>';
