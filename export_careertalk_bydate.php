...
<?php
include('config.php');
$result = mysql_query("SELECT * FROM $careertalk ORDER BY date") or die(mysql_error());
...
echo '<p class="printby"><a href="list_careertalk.php">&larr; Back to System</a> | <a href="export_careertalk.php">Sort by Name</a> | <a href="export_careertalk_bytime.php">Sort by Time</a> | <a href="export_careertalk_bycompany.php">Sort by Company</a></p>';
