...
<?php
 ...
 $data = mysql_query("SELECT * FROM $careertalk WHERE id='$id'") 
 or die(mysql_error()); 
 ...
 mysql_query("UPDATE $careertalk SET name='$name', ic='$ic', matrix='$matrix', course='$course', email='$email', phone='$phone', company='$comp', date='$date', time='$time', year='$year' WHERE id='$id'")
 or die(mysql_error());
 ...
 $result = mysql_query("SELECT * FROM $careertalk WHERE id='$id'")
 or die(mysql_error()); 
