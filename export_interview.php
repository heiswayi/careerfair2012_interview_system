...
<?php
include('config.php');
$result = mysql_query("SELECT * FROM $interview ORDER BY name") or die(mysql_error());
...
echo '<p class="printby"><a href="list_interview.php">&larr; Back to System</a> | <a href="export_interview_bydate.php">Sort by Date</a> | <a href="export_interview_bytime.php">Sort by Time</a> | <a href="export_interview_bycompany.php">Sort by Company</a></p>';
