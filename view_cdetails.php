...
if($row) {
            ...
            echo '<tr><td class="label"></td><td><a target="_blank" class="uiButton uiButtonNormal" href="export_cdetails.php?id=' . $row['id'] . '">Print</a> <a class="uiButton uiButtonNormal" href="do_cdelete.php?id=' . $row['id'] . '">Delete</a> <a class="uiButton uiButtonNormal" href="javascript:history.go(-1)">Back</a></td></tr>';
            echo '</table>';
} else {
            echo '<table>';
