...
<?php
include('config.php');
$result = mysql_query("SELECT * FROM $careertalk WHERE date='$day1' ORDER BY company") or die(mysql_error());
$totalpeople = mysql_num_rows($result);

echo '<h2>List of Attendees for Career Talk Session (' . $totalpeople . ') <a target="_blank" href="javascript:window.print()">PRINT</a><br>';
echo 'Date: ' . $day1 . '</h2>';
echo '<p class="printby"><a href="list_careertalk.php">&larr; Back to System</a> | <a href="checklist_careertalk.php">Day 1</a> | <a href="checklist_careertalk_2.php">Day 2</a></p>';
